...
class ViewController: UIViewController {
    ...
    func matchColorLogic() -> Bool{
        ...
        //randomly select which button has right answer
        ...
        //change 10 to size of array
        var arraySize: Int
        arraySize = myColors.colorsTupleArray.count
        colorNumber = Int(arc4random_uniform(UInt32(arraySize)))
        ...
        var prev = ((colorNumber - 1) + arraySize) % arraySize
        var next = (colorNumber + 1) % arraySize
    ...
    func changeColor() -> Bool{
         ...
         lblChangeColor.backgroundColor = hexStringToUIColor(myColors.colorsTupleArray[colorNumber].hexValue)
